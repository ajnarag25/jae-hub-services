!(function (d) {
  ...
  var x = {
    ...
    initSlider: function (o) {
      ...
      elementorFrontend.config.experimentalFeatures.e_optimized_assets_loading
        ...
        : new Swiper(o, Object.assign(n, i)),
    ...
    getOptions: function (e) {
      var o = void 0 !== e.data("options") ? e.data("options") : {},
        ...
        l =
          ...
          o.centeredSlides,
        f =
          void 0 !== o.sliderScroll && "" !== o.sliderScroll && o.sliderScroll,
        ...
        _ =
          void 0 !== o.speedAnimation && "" !== o.speedAnimation
            ...
            : 800,
        m =
          void 0 !== o.customStages && "" !== o.customStages && o.customStages,
      ...
      return Object.assign(
        {
          ...
          loop: h,
          speed: _,
          navigation: { nextEl: g, prevEl: v },
          pagination: { el: w, type: "bullets", clickable: !0 },
          grabCursor: b,
          breakpoints: {
  ...
  var e = {
    init: function () {
      if (
        ((this.holder = d(".qodef-qi-fslightbox-popup")), this.holder.length)
      ) {
        refreshFsLightbox(),
        ...
        for (const n in fsLightboxInstances)
          fsLightboxInstances[n].props.onInit = () => {
        ...
        this.holder.length &&
          this.holder.each(function () {
            var e,
              o = d(this),
              t =
                ((t = 10), (e = 400), Math.floor(Math.random() * (e - t) + t)),
  ...
  (qodefAddonsCore.qodefScroll = n),
    (qodefAddonsCore.qodefSwiperElementorCheck = {
      init: function (o, t) {
  ...
  (function (d) {
    ...
    var e = {
      init: function () {
        (this.holder = d(".qodef-qi-animated-text.qodef--animated-by-letter")),
          this.holder.length &&
            this.holder.each(function () {
              e.initItem(d(this));
            });
      ...
      initCountdown: function (c, h) {
        var u = new Date(h.date).getTime(),
          q = setInterval(function () {
            ...
            a
              .find(".qodef-label")
              .html(1 === t ? h.monthLabel : h.monthLabelPlural),
              s
                .find(".qodef-label")
                .html(1 === n ? h.dayLabel : h.dayLabelPlural),
              l
                .find(".qodef-label")
                .html(1 === i ? h.hourLabel : h.hourLabelPlural),
              f
                .find(".qodef-label")
                .html(1 === d ? h.minuteLabel : h.minuteLabelPlural),
              e
                .find(".qodef-label")
                .html(1 === r ? h.secondLabel : h.secondLabelPlural),
              (t = t < 10 ? "0" + t : t),
              (n = n < 10 ? "0" + n : n),
              (i = i < 10 ? "0" + i : i),
              (d = d < 10 ? "0" + d : d),
  ...
  (function (n) {
    ...
    var e = {
      init: function () {
        (this.sliders = n(".qodef-qi-device-carousel")),
          this.sliders.length &&
      ...
      initItem: function (o) {
        var t = setInterval(function () {
          if (
            ...
            const e = o.find(
              ".qodef-device-carousel-device .qodef-qi-swiper-container"
            );
            e.each(function () {
              let e = n(this);
    ...
    var o = {
      ...
      parallaxElements: function (e) {
        ...
        1024 < qodefAddonsCore.windowWidth &&
          (void 0 !== i &&
            !1 !== i &&
            ((e = i), (o = Math.abs(parseInt(e / 0.9, 10)))),
          n.attr(
            "data-parallax",
            '{"y" : ' + e + ' , "smoothness": ' + o + "}"
          ),
          t.each(function () {
            ...
            void 0 !== e &&
              !1 !== e &&
              ((d = e), (r = Math.abs(parseInt(d / 2.5, 10)))),
              o.attr(
                "data-parallax",
                '{"y" : ' + d + ' , "smoothness": ' + r + "}"
              );
  ...
  (function (e) {
    ...
    var o = {
      ...
      initSwiperReinit: function (e) {
        ...
        (n[0].swiper.controller.control = d),
          (n[0].swiper.controller.by = "slide"),
          (n[0].swiper.controller.inverse = !0),
          (d.controller.control = n[0].swiper),
    ...
    var u = {
      ...
      initItem: function (e) {
        ...
        e.hasClass("qodef--only-content") &&
          ...
          (o = u.prepareHeadings(n, i, o)).length &&
            (o.each(function (e) {
              var o,
                t,
                n,
        ...
        return (
          ...
          0 !== t.length
            ? ((n = new RegExp(i.id + ";", "g")),
              ...
              (i.finalID = 0 !== e ? i.id + "____" + (e += 1) : i.id))
            : (i.finalID = i.id),
          i
        );
      },
      ...
      animateAnchor: function (e, o) {
        ...
        function a() {
          var e;
          n !== i &&
            (Math.abs(n - i) <= 100 && (r = 8),
            ((-1 == d && n < i) || (1 == d && i < n)) && (n = i),
            (e = u.easingFunction((n - i) / n)),
            h("html, body").scrollTop(n - (n - i) * e),
            (n += d * r),
  ...
  (function (e) {
    ...
    var o = {
      ...
      initSwiperReinit: function (e) {
        ...
        n.width(t.width()),
          n.css("top", t.height()),
          (a = i.find(".swiper-slide").length),
          ((o = d[0].swiper.params).loopedSlides = a),
          (o.autoplay = !1),
          ((n = r[0].swiper.params).grabCursor = !1),
          (n.loopedSlides = a),
          (n.autoplay = !1),
          (n.effect = "fade"),
          (n.allowTouchMove = !1),
          ...
          e("body").on("added_to_cart", function (e) {
            ...
            if (o.length) {
              ...
              o.addClass(i),
                ...
                t.length && ((t = t.clone()), o.append(t)),
                r.length && ((r = r.clone()), o.append(r));
            }
          });
      },
    };
        ...
        !e.hasClass("qodef-item-layout--info-below-swap") ||
          ((e = e.find(".qodef-grid-item")).length &&
            e.each(function () {
              ...
              e.css({ "--qodef-max-width": i, "--qodef-max-height": t }),
