!(function (a) {
  ...
  (window.qodef = {}),
    ...
    a(document).on("loire_trigger_get_new_posts", function () {
      _.init(), o.init();
    });
  var i = {
      init: function () {
    ...
    _ = {
      ...
      getOptions: function (e, t) {
        var i = void 0 !== e.data("options") ? e.data("options") : {},
          ...
          c =
            (void 0 !== i.speed && "" !== i.speed && parseInt(i.speed, 10),
          ...
          h =
                ...
                : a < 5 && (m = a)),
            {
              ...
              loop: d,
              speed: c,
              navigation: { nextEl: g, prevEl: u },
              pagination: { el: p, type: "bullets", clickable: !0 },
              breakpoints: {
                0: {
                  slidesPerView:
          ...
          on: {
            ...
            init: function () {
              ...
              o.addClass("qodef-swiper--initialized"),
                qodef.body.trigger("loire_trigger_swiper_is_initialized", [
                  o,
                  n,
                ]),
                n.sliderScroll &&
      ...
      ((qodef.qodefSwiper = _),
      {
        ...
        initPopup: function (e) {
          e.hasClass("qodef-popup-item")
            ...
            : e.hasClass("qodef-popup-gallery") && o.initGalleryPopup(e);
        },
        ...
        clickTrigger: function () {
          s.items.on("click", function (e) {
            ...
            (i.indexOf("http") < 0 ||
              ...
              (0 === a && i.substring(0, i.length - o.length - 1) === n)) &&
              e.preventDefault(),
              s.animateScroll(t, o);
          });
        },
        ...
        isTargetInView: function (e) {
          ...
          return !(
            Math.floor(100 - ((0 <= e.top ? 0 : e.top) / -+e.height) * 100) <
              20 || Math.floor(100 - ((e.bottom - t) / e.height) * 100) < 20
          );
        },
        ...
        animateScroll: function (e, t) {
          ...
          if (i.length)
            return (
              ...
              qodef.html
                .stop()
                .animate({ scrollTop: Math.round(i) }, 1e3, function () {
  ...
  (function (o) {
    ...
    o(document).ready(function () {
      ...
      o(document).on("loire_trigger_get_new_posts", function (e, t) {
    ...
    var s = {
      ...
      setVisibility: function (e, t) {
        ...
        (n.additional_query_args = { tax_query: a }),
          qodef.body.trigger("loire_trigger_load_more", [e, 1]);
      },
  ...
  (function (r) {
    ...
    r(document).ready(function () {
      ...
      r(document).on("loire_trigger_get_new_posts", function () {
        t.init();
      });
    var t = {
      init: function () {
                ...
                t.find(".qodef-grid-item")
                  ...
                  .each(function () {
                    ...
                    e.height(Math.round(e.height())),
                      i ||
                        0 !== e.width() ||
                        (t.height(t.height() - e.height() - a), (i = !0));
                  });
              }),
  ...
  (function (t) {
    ...
    t(document).ready(function () {
      ...
      t(document).on("loire_trigger_get_new_posts", function (e, t) {
  ...
  (function (t) {
    ...
    var i = {
      ...
      initDropDownMobileMenu: function () {
        var e = t(
          ".qodef-mobile-header-navigation .menu-item-has-children > .qodef-menu-item-arrow, .qodef-mobile-header-navigation .menu-item-has-children.qodef--hide-link > a"
        );
        e.length &&
          e.each(function () {
            var o = t(this);
            o.on("tap click", function (e) {
              ...
              e.hasClass("menu-item-has-children") &&
                ((t = e.find("ul.sub-menu").first()).is(":visible")
                  ? (t.slideUp(450), e.removeClass("qodef--opened"))
  ...
  (function (a) {
    ...
    a(document).ready(function () {
      ...
      a(document).on("loire_trigger_load_more", function (e, t, i) {
    ...
    var s = {
      ...
      triggerStandardScrollAnimation: function (e) {
        e.hasClass("qodef-pagination-type--standard") &&
          a("html, body").animate({ scrollTop: e.offset().top - 100 }, 500);
      },
            ...
            success: function (e) {
              "success" === e.status
                ? (n.max_pages_num !== e.data.max_pages_num &&
                  ...
                  setTimeout(function () {
                    qodef.body.trigger("loire_trigger_get_new_posts", [
                      t,
                      e.data,
                      i,
                    ]);
                  ...
                  s.loadMoreButtonVisibility(t, n))
  ...
  (function (d) {
    ...
    var i = {
              ...
              var t,
                ...
                r =
                  ...
                  Number.isNaN(parseFloat(i.val()))
                    ? a
                    : parseFloat(i.val());
              (s = e.hasClass("qodef-quantity-minus") ? !0 : s)
                ? a <= (t = r - o)
                  ? i.val(t)
                  : i.val(a)
                : ((t = r + o), void 0 !== n && n <= t ? i.val(n) : i.val(t)),
                i.trigger("change");
            }
          );
        },
      ...
      o =
        ...
        {
          init: function () {
            var e = d(".widget .wc-block-product-search");
            e.length &&
              e.each(function () {
                var e = d(this).find(".wc-block-product-search__label"),
                  t = d(this).find(".wc-block-product-search__fields"),
                  i = d(this).find(".wc-block-product-search__field"),
                  o = d(this).find(".wc-block-product-search__button");
                e.length && e.removeClass().addClass("qodef-search-form-label"),
                  t.length &&
                    t.removeClass().addClass("qodef-search-form-inner"),
                  i.length &&
                    i.removeClass().addClass("qodef-search-form-field"),
                  o.length &&
                    (o
                      .removeClass()
                      .addClass(
                        "qodef-search-form-button qodef--button-inside qodef--has-icon"
                      ),
                    o.html(
                      '<svg class="qodef-svg--search" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20" height="20" viewBox="0 0 20 20"><path d="M18.869 19.162l-5.943-6.484c1.339-1.401 2.075-3.233 2.075-5.178 0-2.003-0.78-3.887-2.197-5.303s-3.3-2.197-5.303-2.197-3.887 0.78-5.303 2.197-2.197 3.3-2.197 5.303 0.78 3.887 2.197 5.303 3.3 2.197 5.303 2.197c1.726 0 3.362-0.579 4.688-1.645l5.943 6.483c0.099 0.108 0.233 0.162 0.369 0.162 0.121 0 0.242-0.043 0.338-0.131 0.204-0.187 0.217-0.503 0.031-0.706zM1 7.5c0-3.584 2.916-6.5 6.5-6.5s6.5 2.916 6.5 6.5-2.916 6.5-6.5 6.5-6.5-2.916-6.5-6.5z"></path></svg>'
                    ));
              });
          },
        });
